...
/*
 * Per license agreement, this source file contains edits and is not indicative of the original code
*/
 ...
 */
public class SynchronizedXML<T> extends AbstractItemStreamItemWriter<T> implements
ResourceAwareItemWriterItemStream<T>, InitializingBean {

	private static final Log log = LogFactory.getLog(SynchronizedXML.class);
	...
	public SynchronizedXML() {
		setExecutionContextName(ClassUtils.getShortName(SynchronizedXML.class));
	}
